...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    save: function save() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/phonebook", this.$data).then(function (response) {
...
/* harmony import */ var _Update__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Update */ "./resources/js/components/Update.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    Update: _Update__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  data: function data() {
    return {
      addActive: "",
  ...
  watch: {
    searchQuery: function searchQuery() {
      ...
      if (this.searchQuery.length > 0) {
        this.temp = this.list.filter(function (item) {
          // return item.name.toLowerCase().indexOf(this.searchQuery.toLowerCase()) > -1;
          return Object.keys(item).some(function (key) {
            var string = String(item[key]); // console.log(string)
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/getData").then(function (response) {
      _this2.list = _this2.temp = response.data;
    });
  },
  methods: {
    openAdd: function openAdd() {
      this.addActive = "is-active"; // console.log('tetstst')
    },
    ...
    hapus: function hapus(key, id) {
      ...
      if (confirm('Yakin Hapus ?')) {
        axios__WEBPACK_IMPORTED_MODULE_3___default.a["delete"]("/phonebook/".concat(id)).then(function (response) {
          alert('Data Dihapus');
          _this3.close;

          _this3.list.splice(key, 1);
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Update.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Update.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    update: function update() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.patch("/phonebook/".concat(this.list.id), this.$data.list).then(function (response) {
  ...
  return _c("div", { staticClass: "modal", class: _vm.openmodal }, [
    ...
    _c("div", { staticClass: "modal-card" }, [
      ...
      _c("footer", { staticClass: "modal-card-foot" }, [
        ...
        _vm._v(" "),
        _c("button", { staticClass: "button", on: { click: _vm.tutup } }, [
          _vm._v("Cancel")
        ])
      ])
    ])
        ...
        [
          ...
          _vm._l(_vm.temp, function(item, index) {
            return _c("a", { key: index, staticClass: "panel-block" }, [
              ...
              _vm._v(" "),
              _c("span", { staticClass: "panel-icon column i" }, [
                _c("i", {
                  staticClass: "fas fa-trash has-text-danger",
                  on: {
                    click: function($event) {
                      return _vm.hapus(index, item.id)
                    }
                  }
                })
              ]),
              ...
              _c("span", { staticClass: "panel-icon column i" }, [
                _c("i", {
                  staticClass: "fas fa-edit has-text-info",
                  on: {
                    click: function($event) {
                      return _vm.openUpdate(index)
                    }
                  }
                })
              ]),
              ...
              _c("span", { staticClass: "panel-icon column i" }, [
                _c("i", {
                  staticClass: "fas fa-eye has-text-primary",
                  on: {
                    click: function($event) {
                      return _vm.openShow(index)
                    }
                  }
                })
              ])
  ...
  function() {
    ...
    return _c("footer", { staticClass: "footer" }, [
      _c("div", { staticClass: "content has-text-centered" }, [
        _c("p", [
          _c("strong", [_vm._v("Vue JS Phonebook APP")]),
          _vm._v(" by "),
          _c("a", { attrs: { href: "https://toni-listiyo.com" } }, [
            _vm._v("Toni Listiyo")
          ])
        ])
      ])
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      [
        _c("img", {
          attrs: { src: "#", alt: "Phonebook", width: "112", height: "28" }
        })
      ]
    )
  },
    ...
    _c("div", { staticClass: "modal-card" }, [
      ...
      _c("section", { staticClass: "modal-card-body" }, [
        ...
        _c("div", { staticClass: "field" }, [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "control" }, [
            _c("p", [_vm._v(_vm._s(_vm.list.phone))])
          ])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "field" }, [
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Update.vue?vue&type=template&id=68dc5a74&":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Update.vue?vue&type=template&id=68dc5a74& ***!
  \*********************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "modal", class: _vm.openmodal }, [
    ...
    _c("div", { staticClass: "modal-card" }, [
      _c("header", { staticClass: "modal-card-head" }, [
        _c("p", { staticClass: "modal-card-title" }, [
          _vm._v("Update " + _vm._s(_vm.list.name))
        ]),
        _vm._v(" "),
        _c("button", {
          staticClass: "delete",
...
/* harmony import */ var _components_MyHeader__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/MyHeader */ "./resources/js/components/MyHeader.vue");
/* harmony import */ var _components_MyFooter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/MyFooter */ "./resources/js/components/MyFooter.vue");
...
var app = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  router: router,
  components: {
    MyHeader: _components_MyHeader__WEBPACK_IMPORTED_MODULE_3__["default"],
    MyFooter: _components_MyFooter__WEBPACK_IMPORTED_MODULE_4__["default"]
  }
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Update_vue_vue_type_template_id_68dc5a74___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./Update.vue?vue&type=template&id=68dc5a74& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Update.vue?vue&type=template&id=68dc5a74&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Update_vue_vue_type_template_id_68dc5a74___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Update_vue_vue_type_template_id_68dc5a74___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
__webpack_require__(/*! /srv/http/phonebook/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /srv/http/phonebook/resources/sass/app.scss */"./resources/sass/app.scss");
